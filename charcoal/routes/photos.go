...
func CreatePhoto(runtime *net.RequestRuntime) *net.ResponseBucket {
	...
	if runtime.User.ID >= 1 {
		runtime.Publish(bg.Message{&runtime.User, &photo, bg.VerbCreated})
		return runtime.SendResults(1, photo)
	}

	runtime.Publish(bg.Message{&runtime.Client, &photo, "created"})
	return runtime.SendResults(1, photo)
}
...
func DestroyPhoto(runtime *net.RequestRuntime) *net.ResponseBucket {
	...
	runtime.Publish(bg.Message{&runtime.Client, &photo, bg.VerbDeleted})
	return nil
}
